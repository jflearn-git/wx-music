...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'https://image.baidu.com/search/acjson?tn=resultjson_com&ipn=rj&ct=201326592&is=&fp=result&queryWord+=&cl=&lm=-1&ie=utf-8&oe=utf-8&adpicid=&st=-1&word='+name+'高清&z=&ic=0&s=&se=&tab=&face=0&istype=2&qc=&nc=1&fr=&step_word=高清&pn=0&rn=30&gsm=1e&1512314841233='
, //仅为示例，并非真实的接口地址
      data: {
      },
      header: {
